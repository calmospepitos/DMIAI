...
class KlustRDataSourceViewWidget(QWidget):
    ...
    def __init__(self, klustr_dao, parent=None):
        ...
        self.window_title = 'KlustR Data Viewer'
...
if __name__ == '__main__':
    ...
    print()
    print( " - N'oubliez pas d'installer la base de données 'KlustR' sur 'Postgres' à l'aide de 'pgrestore'.")
    print( "   > pour les détails, voir le fichier 'restore_command.txt'")
    print( " - Pour bien comprendre le projet, il est essentiel de prendre connaissance de la base de données 'KlustR'.")
